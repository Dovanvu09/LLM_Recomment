...
import os
from comparing_prompts import user_prompt_data, collabPrompt, genrePrompts, twoStepPrompt1, twoStepPrompt2, wikiPrompt
...
if option == 'Most Popular':
    ...
    st.table(pd.DataFrame({'Movies': [rec.strip() for rec in recommendations.split('\n')]}))
...
# Run the app with: streamlit run stream_ap.py
